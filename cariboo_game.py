...
# local game_state, not to be confused with the global game_state set in gamestate.py. the global gamestate is set using the set_game_state function
...
def cariboo_game():
    global cariboo_initialize_state

    if cariboo_initialize_state:
        global game_state
        global one_1_image_trans
        global one_2_image_trans
        global one_3_image_trans
        ...
        cariboo_initialize_state = False
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if game_state != 'main_menu':
                ...
                if back_button_rect.collidepoint(event.pos) and game_state != 'cariboo_init':
                    game_state = 'cariboo_init'
                elif back_button_rect.collidepoint(event.pos) and game_state == 'cariboo_init':
